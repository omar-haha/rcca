...
const FAQS_EN = [
  ...
  { q: "What payment methods do you accept?", a: "We accept Interac e-Transfer (Canadian banks) and cryptocurrency (BTC, ETH, USDT). Payment instructions are shown at checkout and on your order confirmation. All prices are in CAD unless otherwise noted." },
...
const FAQS_FR = [
  ...
  { q: "Quels modes de paiement acceptez-vous ?", a: "Nous acceptons le virement Interac (banques canadiennes) et les cryptomonnaies (BTC, ETH, USDT). Les instructions de paiement sont affichées à la caisse et sur la confirmation de commande. Tous les prix sont en CAD, sauf indication contraire." },
