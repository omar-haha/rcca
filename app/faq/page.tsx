...
const FAQS_EN = [
  { q: "What makes VESSEL different?", a: "Every batch we sell is third-party lab tested for potency and purity before it ships. We publish those Certificates of Analysis on our Testing & Quality page and provide them with every order." },
  ...
  { q: "How long does shipping take?", a: "Orders ship within 1–2 business days after payment is confirmed. Standard delivery within Canada is typically 2–5 business days. Expedited options may be available — contact us at support@vesselwellness.example to inquire." },
  { q: "Do you ship internationally?", a: "We currently ship within Canada and to select international destinations. You are solely responsible for ensuring compliance with all import regulations in your jurisdiction. VESSEL reserves the right to refuse shipment to any location." },
  ...
  { q: "Can I get the Certificate of Analysis for my order?", a: "Yes. Every batch ships with a lab-issued Certificate of Analysis, and it's available on request even after delivery. Email support@vesselwellness.example with your order number and the specific product, and we'll provide it within 1 business day." },
  ...
  { q: "Do you offer trade or bulk pricing?", a: "Yes, we work with gyms, trainers, and retail buyers on volume orders. Contact us at support@vesselwellness.example with what you need and we will provide a custom quote." },
...
const FAQS_FR = [
  { q: "Qu'est-ce qui distingue VESSEL ?", a: "Chaque lot que nous vendons est testé par un laboratoire tiers pour la puissance et la pureté avant l'expédition. Nous publions ces certificats d'analyse sur notre page Tests et qualité et les fournissons avec chaque commande." },
  ...
  { q: "Puis-je obtenir le certificat d'analyse pour ma commande ?", a: "Oui. Chaque lot est accompagné d'un certificat d'analyse émis par le laboratoire, disponible sur demande même après la livraison. Écrivez à support@vesselwellness.example avec votre numéro de commande et le produit concerné, et nous vous la fournirons dans un délai d'un jour ouvrable." },
  ...
  { q: "Offrez-vous des tarifs professionnels ou en gros ?", a: "Oui, nous travaillons avec des gyms, des entraîneurs et des détaillants pour les commandes en volume. Contactez-nous à support@vesselwellness.example avec vos besoins et nous vous fournirons un devis personnalisé." },
