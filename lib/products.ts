...
export const products: Product[] = [
  // PEPTIDES
  { id: 'retatrutide', name: 'Retatrutide',   cas: '2381089-83-2', cat: 'peptide',   price: 149.99, unit: '10mg', purity: '≥99%', stock: 'in'  },
  { id: 'bpc157',      name: 'BPC-157',       cas: '137525-51-0',  cat: 'peptide',   price: 74.99,  unit: '5mg',  purity: '≥98%', stock: 'in'  },
  { id: 'tb500',       name: 'TB-500',        cas: '77591-33-4',   cat: 'peptide',   price: 89.99,  unit: '5mg',  purity: '≥98%', stock: 'low' },
  { id: 'ghkcu',       name: 'GHK-Cu',        cas: '49557-75-7',   cat: 'peptide',   price: 59.99,  unit: '50mg', purity: '≥99%', stock: 'in'  },
  { id: 'tirzepatide', name: 'Tirzepatide',   cas: '2023788-19-2', cat: 'peptide',   price: 129.99, unit: '10mg', purity: '≥99%', stock: 'in'  },
