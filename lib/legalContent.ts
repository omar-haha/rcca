...
//
// NOTE: this is a portfolio/demo project. LOAM is not a real registered
...
const ENTITY_EN = "LOAM";
const LIABLE_PARTY_EN = "LOAM, including its owner and operators,";

const ENTITY_FR = "LOAM";
const LIABLE_PARTY_FR = "LOAM, y compris son propriétaire et ses exploitants,";
...
export const LEGAL_EN: LegalContent = {
  disclaimers: [
    { heading: "Product Descriptions", body: "We make every effort to display product colours, materials, and dimensions as accurately as possible. Actual appearance may vary slightly due to display settings and natural material variation (e.g. wood grain, ceramic glaze)." },
    ...
    { heading: "Materials & Sourcing Data", body: `Material composition and care information are produced by our makers and supplied to you as received. ${ENTITY_EN} does not independently verify maker-provided material claims. Materials notes are maker-issued documents; we retain them and provide them on request.` },
  ...
  privacy: [
    ...
    { heading: "Cookies & Analytics", body: "Essential cookies and local storage required for the site to function (session state, the age gate declaration, language selection, and your cookie choice) are always active. Analytics are optional: only if you accept them do we load Google Analytics 4, which sets its own cookies (_ga and _ga_*) and transfers aggregate usage data to Google LLC, including to servers outside Canada. Analytics remain switched off until you accept, declining costs you no functionality, and you can withdraw consent at any time by clearing this site's data in your browser. We use no advertising cookies and run no cross-site tracking." },
    ...
    { heading: "Your Rights (PIPEDA & Law 25)", body: `Under PIPEDA (Canada) and, for Québec residents, the Act respecting the protection of personal information in the private sector (Law 25), you have the right to access, correct, or request deletion of your personal information held by ${ENTITY_EN}, to withdraw a consent you have given, and to know whether your information has been transferred outside Québec. Contact us at support@loamgoods.example to exercise these rights.` },
    { heading: "Contact", body: "Questions regarding this policy may be directed to support@loamgoods.example. This policy was last updated August 2026 and is subject to change without notice." },
  ],
  terms: [
    ...
    { heading: "Materials Data", body: `Material and sourcing data, including any materials note provided to you, are produced by our makers and are passed on as received. ${ENTITY_EN} does not commission independent testing and makes no warranty as to the accuracy of maker-provided data.` },
  ...
  refund: [
    ...
    { heading: "Damaged or Incorrect Orders", body: "If you receive a product that is damaged in transit or materially different from what was ordered, contact us at support@loamgoods.example within 48 hours of delivery with photos and your order number. We will assess and, at our discretion, offer a replacement or store credit." },
    ...
    { heading: "Order Cancellation", body: "Orders may be cancelled within 2 hours of placement if they have not yet been processed. Contact us immediately at support@loamgoods.example. Once an order is in fulfillment it cannot be cancelled." },
  ],
};

export const LEGAL_FR: LegalContent = {
  disclaimers: [
    { heading: "Descriptions des produits", body: "Nous faisons tous les efforts possibles pour afficher les couleurs, matériaux et dimensions des produits aussi fidèlement que possible. L'apparence réelle peut varier légèrement en raison des paramètres d'affichage et de la variation naturelle des matériaux (p. ex. grain du bois, glaçure céramique)." },
    ...
    { heading: "Données sur les matériaux", body: `La composition des matériaux et les informations d'entretien sont produites par nos artisans et vous sont transmises telles que reçues. ${ENTITY_FR} ne vérifie pas de façon indépendante les allégations des artisans concernant les matériaux. Les fiches matériaux sont des documents émis par les artisans ; nous les conservons et les fournissons sur demande.` },
  ...
  terms: [
    ...
    { heading: "Données sur les matériaux", body: `Les données sur les matériaux et l'approvisionnement, y compris toute fiche matériaux qui vous est fournie, sont produites par nos artisans et vous sont transmises telles que reçues. ${ENTITY_FR} ne commande pas de tests indépendants et ne garantit pas l'exactitude des données fournies par les artisans.` },
  ...
  refund: [
    ...
    { heading: "Annulation de commande", body: "Les commandes peuvent être annulées dans les 2 heures suivant leur passage si elles n'ont pas encore été traitées. Contactez-nous immédiatement à support@loamgoods.example. Une fois une commande en cours de traitement, elle ne peut être annulée." },
  ],
};
