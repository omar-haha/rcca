...
// Fired when the gate is dismissed. components/Analytics.tsx waits for this (or
// for rc_age_ok to already be set) before offering the cookie choice, so the two
// prompts never compete for the screen.
export const AGE_GATE_CLEARED = "rc:age-gate-cleared";
...
export function AgeGateModal() {
  ...
  const handleEnter = () => {
    ...
    setTimeout(() => {
      ...
      // Lets the analytics consent banner surface only once this gate is gone —
      // it sits at a much lower z-index and would otherwise be hidden behind it.
      window.dispatchEvent(new Event(AGE_GATE_CLEARED));
    }, 300);
  };
    ...
    >
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center text-center">
          {/* Logo */}
          <BrandLogo className="h-[16px] w-auto text-logo mb-8" />
